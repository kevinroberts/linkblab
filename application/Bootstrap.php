...
{	
	...
	protected function _initResources()
    {
    	...
    	define("DECODAPOST",     "b,i,u,align,color,font,sub,sup,code,url,quote,list,olist,email,li,decode,spoiler");
    	define("DECODACOMMENT",     "b,i,u,color,sub,sup,url,quote,list,olist,email,spoiler,li,code,decode");
